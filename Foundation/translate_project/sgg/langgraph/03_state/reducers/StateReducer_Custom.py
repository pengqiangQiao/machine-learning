...
def second_multiplier(state: MultiplyState) -> dict:
    return {"factor": 3.0}
...
def run_demo():
    ...
    builder.add_node("second_multiplier", second_multiplier)
    builder.add_edge(START, "multiplier")
    builder.add_edge("multiplier", "second_multiplier")
    builder.add_edge("second_multiplier", END)
